...
function validate(e) {
    ...
    if (isNaN(ass1) || ass1 === null || ass1 === "") {
        ...
        addError("The Tutorial Assessment grade must be between 0 and 100 (inclusive)");
...
function calculateGrade() {
    ...
    gradeArray.push((assignment3 / 100) * 10);
    gradeArray.push((assignment4 / 100) * 20);
